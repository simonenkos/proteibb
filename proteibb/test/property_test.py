...
class PropertyTestCase(unittest.TestCase):
    ...
    def test_dependencies_property(self):
        ...
        self.assertEqual(dp.get_value().get_versions(), {'ver': [], 'min': None, 'max': None})
        self.assertEqual(dp.set_value('lib_a:=1.0:=2.0'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_a')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [[1, 0], [2, 0]], 'min': None, 'max': None})
        self.assertEqual(dp.set_value('lib_b:>1.0:<2.0'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_b')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [], 'min': [1, 0], 'max': [2, 0]})
        self.assertEqual(dp.set_value('lib_c:=1.0:>2.0'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_c')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [[1, 0]], 'min': [2, 0], 'max': None})
        self.assertEqual(dp.set_value('lib_d:=2.0:>2.0'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_d')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [[2, 0]], 'min': [2, 0], 'max': None})
        self.assertEqual(dp.set_value('lib_e:=1.0:=1.3:>2.0'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_e')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [[1, 0], [1, 3]], 'min': [2, 0], 'max': None})
        self.assertEqual(dp.set_value('lib_f:<1.0.5:=1.0.7:=1.1.14'), None)
        self.assertEqual(dp.get_value().get_name(), 'lib_f')
        self.assertEqual(dp.get_value().get_versions(), {'ver': [[1, 0, 7], [1, 1, 14]], 'min': None, 'max': [1, 0, 5]})
